...
import {
  DiscountClass, DiscountMethod, SummaryCard, CombinationCard,
...
export const NewDiscount = ({isEditing = false}) => {
  ...
  const handleSubmit = async (event) => {
    ...
    const formData = {
      title, products, discountValues, isActive: true, combinesWith, saveDiscount: true
    }
    ...
    <PolarisAppProvider i18n={enPolarisTranslations}>
      <DiscountsProvider locale="en-US" ianaTimezone="America/Los_Angeles">
        <PageLayout
          ...
          titleMetadata={status === "draft" ? (<Badge tone="info"> Draft </Badge>) : (
                ...
                <BlockStack gap="500">
                  ...
                  <Card>
                    <BlockStack gap="300">
                      ...
                      <BlockStack gap="400">
                        {discountValues?.map((item, i) => (<Card roundedAbove="xs" key={i}>
                          <BlockStack gap="200">
                            <InlineStack align="space-between">
                  ...
                  <div>
                    <CombinationCard
                      combinableDiscountTypes={{
                        value: combinesWith, onChange: setCombinesWith,
                      }}
